		...
		extend: {
			...
			colors: {
				...
				departments: {
					...
					sampling: 'hsl(var(--sampling))',
					merchandising: 'hsl(var(--merchandising))',
					logistics: 'hsl(var(--logistics))',
					procurement: 'hsl(var(--procurement))',
			...
			keyframes: {
				...
				'backdrop-blur-in': {
					...
					'100%': { backdropFilter: 'blur(8px)', opacity: '1' }
				}
			},
			animation: {
